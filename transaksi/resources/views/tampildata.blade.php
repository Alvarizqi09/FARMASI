...
<html lang="en">
  ...
  <h1 class='text-center mb-5 mt-5'>Edit Data Transaksi</h1>
        ...
        <div class="card-body">
          <form action="/updatedata/{{ $data->id }}" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
              ...
              <input type="text" name="notransaksi" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{ $data->notransaksi }}">
            </div>
            <div class="mb-3">
              <label for="exampleInputEmail1" class="form-label">Tanggal Transaksi</label>
              <input type="date" name="tgltransaksi" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{ $data->tgltransaksi }}">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
              ...
              <input type="text" name="jumlahobat" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{ $data->jumlahobat }}">
            </div>
            <div class="mb-3">
